...
const weather = require("./src/weather/weather-promise")
...
try {
    var forecast = weather.forecast(argv.address);
    console.log(forecast);
    console.log(`It's currently ${forecast.temperature}, but it feels like ${forecast.apparenTemperature}`);
} catch (e) {
    if (e.code === 'ENOTFOUND') {
